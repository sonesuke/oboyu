...
class SearchContext:
    ...
    def with_explicit_reranker(self, enabled: bool) -> "SearchContext":
        ...
        if self.use_reranker is not None:
            raise ValueError(f"Reranker already explicitly set to {self.use_reranker}. Cannot override explicit user preference.")
    ...
    def with_explicit_top_k(self, top_k: int) -> "SearchContext":
        ...
        if self.top_k is not None:
            raise ValueError(f"Top-k already explicitly set to {self.top_k}. Cannot override explicit user preference.")
    ...
    def with_explicit_reranker_model(self, model: str) -> "SearchContext":
        ...
        if self.reranker_model is not None:
            raise ValueError(f"Reranker model already explicitly set to {self.reranker_model}. Cannot override explicit user preference.")
