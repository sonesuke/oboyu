...
class PDFPerformanceComparator:
    ...
    def compare_processing(self, file_path: Path) -> Dict[str, Any]:
        ...
        try:
            ...
            results["optimized"] = {"error": str(e), "success": False}
        ...
        try:
            ...
            results["original"] = {"time": orig_time, "content_length": len(orig_content), "pages": orig_metadata.get("total_pages", 0), "success": True}
        except Exception as e:
