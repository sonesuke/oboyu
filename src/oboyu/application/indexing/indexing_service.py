...
class IndexingService:
    ...
    def __init__(
        self, search_repository: SearchRepository, embedding_service: EmbeddingService, filesystem_port: FilesystemPort, document_processor: DocumentProcessor
    ) -> None:
    ...
    async def index_directory(self, directory_path: Path, include_patterns: List[str] = None, exclude_patterns: List[str] = None) -> None:
        """Index all documents in a directory."""
        discovered_files = await self._filesystem_port.discover_files(directory_path, include_patterns, exclude_patterns)
