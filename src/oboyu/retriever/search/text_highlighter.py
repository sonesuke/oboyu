...
class TextHighlighter:
    ...
    def highlight_matches(self, text: str, matches: List[str], case_sensitive: bool = False) -> str:
        ...
        for match in matches:
            ...
            highlighted_text = self._highlight_single_match(highlighted_text, match, case_sensitive)
    ...
    def _highlight_single_match(self, text: str, match: str, case_sensitive: bool = False) -> str:
        ...
        return pattern.sub(lambda m: self.highlight_format.format(m.group()), text)
