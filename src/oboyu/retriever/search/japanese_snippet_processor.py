...
class JapaneseSnippetProcessor:
    ...
    def is_japanese_text(self, text: str) -> bool:
        ...
        return bool(self.HIRAGANA_RANGE.search(text) or self.KATAKANA_RANGE.search(text) or self.KANJI_RANGE.search(text))
    ...
    def adjust_to_sentence_boundaries(self, text: str, prefer_complete: bool = True) -> str:
    ...
    def adjust_to_paragraph_boundaries(self, text: str, prefer_complete: bool = True) -> str:
