...
class Document:
    ...
    def should_be_processed(self) -> bool:
        ...
        return not self.is_empty() and self.get_size() > 10 and self.language != LanguageCode.UNKNOWN

    def create_updated_copy(self, *, content: Optional[str] = None, title: Optional[str] = None) -> "Document":
