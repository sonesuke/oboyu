...
class Chunk:
    ...
    def is_meaningful(self) -> bool:
        ...
        return len(self.content.strip()) > 10 and self.get_word_count() > 3 and not self.content.isspace()
    ...
    def should_be_indexed(self) -> bool:
        ...
        return self.is_meaningful() and self.language != LanguageCode.UNKNOWN and len(self.content.strip()) >= 5
