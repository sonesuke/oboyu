...
class SearchEngine:
    ...
    def combine_results(
        self, vector_results: List[SearchResult], bm25_results: List[SearchResult], vector_weight: float = 0.7, bm25_weight: float = 0.3
    ) -> List[SearchResult]:
    ...
    def _add_highlights(self, query: Query, result: SearchResult) -> SearchResult:
        ...
        for term in query_terms:
            if term.lower() in content:
                ...
                highlighted_content = highlighted_content.replace(term, f"**{term}**")
