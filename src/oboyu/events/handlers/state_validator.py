...
class IndexStateValidator(EventHandler):
    ...
    def handle(self, event: IndexEvent) -> None:
        ...
        try:
            ...
            self._publish_corruption_event(
                operation_id=event.operation_id, corruption_type="validation_error", description=f"State validation failed: {e}", severity="high"
            )
    ...
    def _validate_indexing_integrity(self, operation_id: str) -> None:
        ...
        try:
            ...
            self._publish_corruption_event(
                operation_id=operation_id, corruption_type="database_error", description=f"Database integrity check failed: {e}", severity="medium"
            )
    ...
    def _ensure_clean_state(self, operation_id: str) -> None:
        ...
        try:
            ...
            self._publish_corruption_event(
                operation_id=operation_id, corruption_type="clean_state_error", description=f"Clean state validation failed: {e}", severity="medium"
            )
    ...
    def _validate_hnsw_index(self, operation_id: str) -> None:
        ...
        try:
            ...
            self._publish_corruption_event(
                operation_id=operation_id, corruption_type="hnsw_index_error", description=f"HNSW index validation failed: {e}", severity="medium"
            )
    ...
    def _validate_bm25_index(self, operation_id: str) -> None:
        ...
        try:
            ...
            self._publish_corruption_event(
                operation_id=operation_id, corruption_type="bm25_index_error", description=f"BM25 index validation failed: {e}", severity="medium"
            )
    ...
    def _publish_corruption_event(self, operation_id: str, corruption_type: str, description: str, severity: str = "medium") -> None:
        ...
        if self.event_bus:
            corruption_event = IndexCorruptionDetectedEvent(
                operation_id=operation_id, corruption_type=corruption_type, description=description, severity=severity
            )
