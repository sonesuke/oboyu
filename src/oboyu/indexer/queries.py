...
class QueryBuilder:
    ...
    @staticmethod
    def search_by_vector(query_vector: Union[List[float], NDArray[np.float32]],
                        limit: int = 10, language: Optional[str] = None,
                        embedding_dimensions: int = 256) -> Tuple[str, List[Any]]:
    ...
    @staticmethod
    def search_by_bm25(query_terms: List[str], limit: int = 10,
                      language: Optional[str] = None) -> Tuple[str, List[Any]]:
    ...
    def insert_vocabulary_term(vocab_data: VocabularyData) -> Tuple[str, List[Any]]:
        ...
        params = [
            vocab_data.term,
            vocab_data.document_frequency,
            vocab_data.collection_frequency
        ]
    ...
    def upsert_document_stats(stats_data: DocumentStatsData) -> Tuple[str, List[Any]]:
        ...
        params = [
            stats_data.chunk_id,
            stats_data.total_terms,
            stats_data.unique_terms,
            stats_data.avg_term_frequency
        ]
    ...
    def upsert_collection_stats(stats_data: CollectionStatsData) -> Tuple[str, List[Any]]:
        ...
        params = [
            stats_data.total_documents,
            stats_data.total_terms,
            stats_data.avg_document_length,
