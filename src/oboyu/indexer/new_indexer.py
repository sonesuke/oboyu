...
class NewIndexer:
    ...
    def index_documents(self, crawler_results: List[CrawlerResult]) -> dict:
        ...
        try:
            ...
            # Update BM25 index
            texts_for_bm25 = self.document_processor.prepare_for_bm25(all_chunks)
            self.bm25_indexer.add_documents(texts_for_bm25, chunk_ids)
