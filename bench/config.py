...
DATASET_SIZES = {
    "small": {
        "name": "Small Dataset",
        "file_count": 50,
        "files_per_type": {".txt": 20, ".md": 15, ".py": 10, ".html": 5},
        "content_size_range": (1000, 5000),  # Characters per file
    },
    "medium": {
        "name": "Medium Dataset",
        "file_count": 1000,
        "files_per_type": {".txt": 400, ".md": 300, ".py": 200, ".html": 100},
        "content_size_range": (2000, 10000),
    },
    "large": {
        "name": "Large Dataset",
        "file_count": 10000,
        "files_per_type": {".txt": 4000, ".md": 3000, ".py": 2000, ".html": 1000},
...
QUERY_CONFIG = {
    ...
    "english": {"count": 50, "types": {"technical": 15, "business": 15, "general": 10, "code": 10}},
    "mixed": {
        "count": 20,  # Mixed Japanese-English queries
        "types": {"technical": 10, "general": 10},
    },
}
...
BENCHMARK_CONFIG = {
    ...
    "search": {
        ...
        "metrics": ["response_time", "queries_per_second", "first_result_time", "total_results_time"],
    },
}
...
MONITORING_CONFIG = {
    ...
    "metrics": ["cpu_percent", "memory_usage_mb", "disk_io_read_mb", "disk_io_write_mb"],
}

# Output configuration
OUTPUT_CONFIG = {"formats": ["json", "text"], "pretty_print": True, "save_raw_data": True, "timestamp_format": "%Y%m%d_%H%M%S"}
...
OBOYU_CONFIG = {
    ...
    "indexer": {"chunk_size": 300, "chunk_overlap": 75, "embedding_model": "cl-nagoya/ruri-v3-30m", "embedding_device": "cpu", "batch_size": 8},
    "query": {
