...
def mock_search_results():
    ...
    return [
        SearchResult(chunk_id="chunk1", path="test1.txt", content="Test content 1", score=0.9, chunk_index=0, title="Test 1", language="en"),
        SearchResult(chunk_id="chunk2", path="test2.txt", content="Test content 2", score=0.8, chunk_index=1, title="Test 2", language="en"),
    ]
...
class TestQueryService:
    ...
    def test_get_query_config_with_overrides(self, query_service):
        ...
        result = query_service.get_query_config(top_k=5, vector_weight=0.8, bm25_weight=0.2, rerank=True)
    ...
    def test_execute_query_with_overrides(self, mock_retriever_class, query_service, mock_search_results):
        ...
        result = query_service.execute_query("test query", mode="hybrid", top_k=5, vector_weight=0.8, bm25_weight=0.2, db_path=Path("/custom/db.db"))
