...
class TestMCPService:
    ...
    def test_create_indexer_config(self, mcp_service):
        ...
        mcp_service.config_manager.resolve_db_path.assert_called_once_with(Path("custom.db"), mcp_service.config_manager.get_section.return_value)
    ...
    def test_create_indexer_config_no_path(self, mcp_service):
        ...
        mcp_service.config_manager.resolve_db_path.assert_called_with(None, mcp_service.config_manager.get_section.return_value)
