...
from oboyu.events.handlers.metrics_collector import IndexMetrics, IndexMetricsCollector
...
class TestIndexMetricsCollector:
    ...
    def test_handle_indexing_started_event(self):
        ...
        collector = IndexMetricsCollector()
        event = IndexingStartedEvent(document_count=10, operation_id="test-op-1")
    ...
    def test_handle_indexing_completed_event(self):
        ...
        collector = IndexMetricsCollector()
        event = IndexingCompletedEvent(duration_seconds=5.5, chunks_created=25, embeddings_generated=25, operation_id="test-op-1")
    ...
    def test_handle_indexing_failed_event(self):
        ...
        collector = IndexMetricsCollector()
        event = IndexingFailedEvent(error="Test error", operation_id="test-op-1")
    ...
    def test_handle_corruption_detected_event(self):
        ...
        collector = IndexMetricsCollector()
        event = IndexCorruptionDetectedEvent(severity="high", corruption_type="data_mismatch")
    ...
    def test_handle_embedding_generated_event(self):
        ...
        collector = IndexMetricsCollector()
        event = EmbeddingGeneratedEvent(chunk_count=30)
    ...
    def test_handle_bm25_index_updated_event(self):
        ...
        collector = IndexMetricsCollector()
        event = BM25IndexUpdatedEvent(documents_indexed=15)
