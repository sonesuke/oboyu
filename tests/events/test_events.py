...
class TestEventTypes:
    ...
    def test_indexing_started_event(self):
        ...
        event = IndexingStartedEvent(document_count=10, total_size_bytes=1024, source_path="/test/path")
    ...
    def test_indexing_completed_event(self):
        ...
        event = IndexingCompletedEvent(document_count=10, chunks_created=50, embeddings_generated=50, duration_seconds=5.5, success=True)
    ...
    def test_indexing_failed_event(self):
        ...
        event = IndexingFailedEvent(error="Test error", error_type="ValueError", document_count_processed=5, duration_seconds=2.5)
    ...
    def test_document_processed_event(self):
        ...
        event = DocumentProcessedEvent(document_path="/test/doc.txt", chunks_created=3, embeddings_generated=3, processing_time_seconds=1.2, success=True)
    ...
    def test_database_cleared_event(self):
        ...
        event = DatabaseClearedEvent(records_deleted=100, tables_cleared=["chunks", "embeddings"])
    ...
    def test_database_clear_failed_event(self):
        ...
        event = DatabaseClearFailedEvent(error="Permission denied", error_type="PermissionError")
    ...
    def test_index_corruption_detected_event(self):
        ...
        event = IndexCorruptionDetectedEvent(
            corruption_type="data_mismatch", affected_tables=["chunks", "embeddings"], severity="high", description="Chunk count doesn't match embedding count"
        )
    ...
    def test_index_health_check_event(self):
        ...
        event = IndexHealthCheckEvent(
            health_status="healthy", checks_performed=["connection", "integrity"], issues_found=[], total_documents=50, total_chunks=200, total_embeddings=200
        )
    ...
    def test_embedding_generated_event(self):
        ...
        event = EmbeddingGeneratedEvent(chunk_count=25, embedding_model="sentence-transformers/all-MiniLM-L6-v2", processing_time_seconds=3.5, success=True)
    ...
    def test_bm25_index_updated_event(self):
        ...
        event = BM25IndexUpdatedEvent(terms_indexed=1500, documents_indexed=10, processing_time_seconds=2.0, success=True)
    ...
    def test_hnsw_index_created_event(self):
        ...
        event = HNSWIndexCreatedEvent(vector_count=200, index_parameters={"ef_construction": 200, "M": 16}, processing_time_seconds=1.5, success=True)
    ...
    def test_database_connection_event(self):
        ...
        event = DatabaseConnectionEvent(connection_status="connected", database_path="/test/db.duckdb")
    ...
    def test_event_to_dict(self):
        ...
        event = IndexingStartedEvent(document_count=5, total_size_bytes=1024, source_path="/test")
