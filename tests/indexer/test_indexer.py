...
class TestIndexerIntegration:
    """Integration tests for the Indexer with Crawler component."""

    def test_index_directory(self) -> None:
        """Test indexing a directory using the crawler integration."""
        with patch("oboyu.indexer.indexer.Crawler") as mock_crawler_class, \
             patch("oboyu.indexer.indexer.DocumentProcessor") as mock_processor, \
             patch("oboyu.indexer.indexer.EmbeddingGenerator") as mock_generator, \
             patch("oboyu.indexer.indexer.Database") as mock_db:
            ...
            mock_generator.return_value.generate_embeddings.return_value = [
                ("test-embedding-1", "test-chunk-1", np.array([0.1] * 256), datetime.now())
            ]
            ...
            indexer = Indexer(
                ...
                embedding_generator=mock_generator.return_value,
            ...
            mock_db.return_value.store_chunks.assert_called_once()
            mock_db.return_value.store_embeddings.assert_called_once()