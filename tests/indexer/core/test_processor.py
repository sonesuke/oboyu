...
from oboyu.indexer.core.document_processor import DocumentProcessor, chunk_documents
...
class TestDocumentProcessor:
    ...
    def test_chunk_documents_helper(self) -> None:
        ...
        docs = [
            {"path": "/test/doc1.txt", "content": "Content of document 1. " * 5, "title": "Doc 1", "language": "en", "metadata": {"source": "test1"}},
            {"path": "/test/doc2.txt", "content": "Content of document 2. " * 5, "title": "Doc 2", "language": "en", "metadata": {"source": "test2"}},
        ]
