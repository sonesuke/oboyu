...
class TestInstallationValidation:
    ...
    def test_cli_entry_point(self):
        ...
        result = subprocess.run([sys.executable, "-m", "oboyu", "--help"], capture_output=True, text=True)
    ...
    def test_console_script_installation(self):
        ...
        if result.returncode == 0:
            ...
            result = subprocess.run([sys.executable, "-m", "oboyu", "version"], capture_output=True, text=True)
