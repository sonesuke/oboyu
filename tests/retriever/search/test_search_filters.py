...
class TestPathFilter:
    ...
    def test_path_matching_both_patterns(self) -> None:
        ...
        filter_obj = PathFilter(include_patterns=["*/docs/*"], exclude_patterns=["*/test/*"])
...
class TestSearchFilters:
    ...
    def test_from_dict_date_range_only(self) -> None:
        ...
        filter_dict = {"date_range": {"start": "2024-01-01", "end": "2024-12-31", "field": "created_at"}}
    ...
    def test_from_dict_path_filter_only(self) -> None:
        ...
        filter_dict = {"path_filter": {"include_patterns": ["*/docs/*", "*.md"], "exclude_patterns": ["*/test/*"]}}
    ...
    def test_from_dict_both_filters(self) -> None:
        ...
        filter_dict = {"date_range": {"start": "2024-01-01"}, "path_filter": {"include_patterns": ["*.md"]}}
    ...
    def test_to_sql_conditions_date_range_only(self) -> None:
        ...
        date_range = DateRangeFilter(start=datetime(2024, 1, 1), end=datetime(2024, 12, 31), field="modified_at")
        filters = SearchFilters(date_range=date_range)
    ...
    def test_to_sql_conditions_path_filter_only(self) -> None:
        ...
        path_filter = PathFilter(include_patterns=["*/docs/*"], exclude_patterns=["*/test/*", "*.log"])
        filters = SearchFilters(path_filter=path_filter)
