...
class TestSearchContext:
    ...
    def test_context_builder_fluent_interface(self) -> None:
        ...
        context = ContextBuilder().with_reranker(True, SettingSource.CLI_ARGUMENT).with_top_k(20, SettingSource.FUNCTION_CALL).build()
    ...
    def test_context_builder_from_cli_args(self) -> None:
        ...
        context = ContextBuilder().from_cli_args(top_k=15, use_reranker=True).build()
    ...
    def test_context_builder_from_function_args(self) -> None:
        ...
        context = ContextBuilder().from_function_args(top_k=30, use_reranker=False).build()
    ...
    def test_context_builder_ignores_none_values(self) -> None:
        ...
        context = ContextBuilder().from_cli_args(top_k=None, use_reranker=True).build()
    ...
    def test_get_all_explicit_settings(self) -> None:
        ...
        context = ContextBuilder().with_reranker(True, SettingSource.CLI_ARGUMENT).with_top_k(25, SettingSource.FUNCTION_CALL).build()
...
class TestSearchContextIntegration:
    ...
    def test_multiple_explicit_settings_preserved(self) -> None:
        ...
        context = ContextBuilder().from_cli_args(use_reranker=True, top_k=50).build()
