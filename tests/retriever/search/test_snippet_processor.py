...
class TestSnippetProcessor:
    ...
    def test_japanese_text_processing(self):
        ...
        config = SnippetConfig(length=200, japanese_aware=True, strategy=SnippetStrategy.SENTENCE_BOUNDARY, highlight_matches=False)
        processor = SnippetProcessor(config)
    ...
    def test_sentence_boundary_strategy(self):
        ...
        config = SnippetConfig(length=150, strategy=SnippetStrategy.SENTENCE_BOUNDARY, prefer_complete_sentences=True, highlight_matches=False)
        processor = SnippetProcessor(config)
    ...
    def test_context_window(self):
        ...
        config = SnippetConfig(length=200, context_window=30, highlight_matches=False)
        processor = SnippetProcessor(config)
    ...
    def test_no_matches_fixed_length(self):
        ...
        config = SnippetConfig(length=50, strategy=SnippetStrategy.FIXED_LENGTH, highlight_matches=False)
        processor = SnippetProcessor(config)
    ...
    def test_multi_level_snippets(self):
        ...
        config = SnippetConfig(length=300, levels=levels, highlight_matches=False)
        processor = SnippetProcessor(config)
    ...
    def test_japanese_sentence_boundaries(self):
        ...
        config = SnippetConfig(
            length=200, strategy=SnippetStrategy.SENTENCE_BOUNDARY, japanese_aware=True, prefer_complete_sentences=True, highlight_matches=False
        )
        processor = SnippetProcessor(config)
