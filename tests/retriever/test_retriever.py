...
class TestRetrieverInitialization:
    ...
    def test_init_with_config(self, mock_config: IndexerConfig) -> None:
        ...
        with patch("oboyu.retriever.retriever.ServiceRegistry"), patch("oboyu.retriever.retriever.SearchOrchestrator"):
    ...
    def test_init_without_config(self) -> None:
        ...
        with (
            patch("oboyu.retriever.retriever.ServiceRegistry"),
...
class TestRetrieverSearch:
    ...
    def test_search_hybrid_mode(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_search_vector_mode(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_search_bm25_mode(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_search_invalid_mode(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_search_with_filters(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
        """Test search with filters."""
        retriever.search_orchestrator.search.return_value = sample_search_results

        filters = SearchFilters()
        results = retriever.search("test query", language_filter="en", filters=filters)
...
class TestRetrieverVectorSearch:
    ...
    def test_vector_search_with_string(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_vector_search_with_embedding(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
    ...
    def test_vector_search_legacy_limit_parameter(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
...
class TestRetrieverBM25Search:
    ...
    def test_bm25_search(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
        """Test BM25 search."""
    ...
    def test_bm25_search_with_language_filter(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
...
class TestRetrieverHybridSearch:
    ...
    def test_hybrid_search(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
        """Test hybrid search."""
    ...
    def test_hybrid_search_custom_weights(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
...
class TestRetrieverReranking:
    ...
    def test_rerank_results(self, retriever: Retriever, sample_search_results: list[SearchResult]) -> None:
        ...
        retriever.search_orchestrator.rerank_results.assert_called_once_with("test query", sample_search_results)
