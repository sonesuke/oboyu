...
class TestIndexHealthMonitor:
    ...
    def test_handle_indexing_completed_event(self):
        ...
        monitor = IndexHealthMonitor()
        event = IndexingCompletedEvent(operation_id="op-1", duration_seconds=5.5)
    ...
    def test_handle_indexing_failed_event(self):
        ...
        monitor = IndexHealthMonitor()
        event = IndexingFailedEvent(operation_id="op-1", error_type="ValueError", duration_seconds=2.0)
